    ...
    3847: function(t, e, r) {
        ...
        e.default = function(t) {
            ...
            s.useMemo)(()=>{
                let t = {};
                return {
                    resolveName: async e=>(t[e] || (t[e] = new Promise(async t=>{
            ...
            function E(t) {
                ...
                sessionStorage.setItem("ethereum-address", t)
            }
            (0,
            s.useEffect)(()=>{
                let t = sessionStorage.getItem("ethereum-ethereumAddress");
                t && b({
                    ethereumAddress: t
                })
            }
                ...
                (async()=>{
                    ...
                    let r = t=>{
                        ...
                        if (e) {
                            ...
                            r.includes(t.chainId) ? v ? (m("connected"),
                            y({
                                name: e,
                                id: t.chainId
                            })) : (m("wallet_available"),
                            y(null)) : (m("wrong_network"),
                            y(null))
                        } else
                            m("wrong_network"),
                            y(null)
            ...
            s.useMemo)(()=>{
                ...
                l.Vb)(h.pn)),
                {
                    ethereumAddress: null == v ? void 0 : v.ethereumAddress,
                    walletNetwork: g,
                    network: r,
                    provider: t,
                    contractInstance: e,
